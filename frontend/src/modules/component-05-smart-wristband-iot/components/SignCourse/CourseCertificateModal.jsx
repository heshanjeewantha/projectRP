        ...
        >
          ...
          <div className="mt-6 flex flex-wrap items-center justify-between gap-3">
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-4 py-2.5 text-xs font-bold text-slate-300 hover:bg-white/10 transition-all"
            >
              <RotateCcw size={15} />
              Restart Course
            </button>
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={handlePrint}
                className="flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-xs font-bold text-white shadow-lg shadow-primary/30 hover:bg-primary/90 transition-all"
              >
                <Printer size={15} />
